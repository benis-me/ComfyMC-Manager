  ...
  if (ModelInstaller.instance) {
    ...
    try {
      ...
      ModelInstaller.instance.updateMessage(
        "<BR>To apply the installed model, please click the 'Refresh' button on the main menu."
      )
    }
  }
}
...
export class ModelInstaller extends ComfyDialog {
  ...
  startInstall(target) {
    ...
    self.updateMessage(
      `<BR><font color="green">Installing '${target.name}'</font>`
    )
